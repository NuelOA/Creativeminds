                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <span id="caption"><span id="infant"><i class="fa fa-check-circle"></i>&nbsp;Infant</span>&nbsp;&nbsp;
                      <span id="toddler"><i class="fa fa-check-circle"></i>&nbsp;Toddler</span>&nbsp;&nbsp; <br />
                      <span id="preschool"><i class="fa fa-check-circle"></i>&nbsp;Preschool</span>
                      {/* <span id="kindergarten"><i class="fa fa-check-circle"></i>&nbsp;Kindergarten</span> </span> */}
                    </span>
                    <br />

                    <Link to="/Admission"><button class="btn"><i class="fa fa-pen">&nbsp;</i>Enroll Now</button></Link>
                  </div>
